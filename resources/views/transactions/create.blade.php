                ...
                <form action="{{ route('transaction.store') }}" method="POST">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Cadastrar Transação</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group" style="max-width: 250px;">
                                ...
                                <input type="date" name="action_date" class="form-control @error('action_date') is-invalid @enderror" value="{{ old('action_date') }}">
                                @error('action_date')
                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                @enderror
                            </div>
